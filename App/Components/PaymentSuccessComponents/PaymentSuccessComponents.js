...
const PaymentSuccessComponents = props => {
          ...
          <ViewShot
            ...
            Data?.transaction_error_type == 'success' ? (
              <Text style={styles.paymentDes}>
                Your transaction has been successfully processed and meal
                subscription plan is done
              </Text>
            ) : (
              <Text style={styles.paymentDes}>
                Your transaction has been not successfully processed and meal
                subscription plan is not done.
              </Text>
            )}
            ...
            <View style={styles.cardBoxContainer}>
              ...
              <View
                ...
                <Text style={styles.paidAmount}>Status of transaction </Text>
                <Text style={styles.amountText}>
                  {Data?.auth_status === '0300'
                    ? 'Success'
                    : Data?.auth_status === '0399'
                    ? 'Failed'
                    : 'Pending'}
                </Text>
              </View>
              <View
                ...
                <Text style={styles.amountText}>{Data?.orderid}</Text>
              </View>
              <View
                style={{
                  flexDirection: 'row',
                ...
                <Text
                  style={[styles.amountText, {textTransform: 'capitalize'}]}>
...
export default PaymentSuccessComponents;
